...
function validate(validateObj: Validatable) {
    ...
    if (
        validateObj.minLength !== undefined &&
    ...
    if (
        validateObj.maxLength !== undefined &&
        typeof validateObj.value === 'string'
    ) {
